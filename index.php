...
// Fetch Special Products grouped by status
...
<head>
    ...
    <style>
        ...
        .btn-primary-custom { background: #000; color: #fff; border-radius: 8px; transition: 0.3s; }
        .btn-primary-custom:hover { background: #333; }
    </style>
</head>
<body>
...
<nav class="glass-nav sticky top-0 z-50 border-b border-gray-100">
    <div class="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div class="flex items-center space-x-5 text-lg">
            <a href="signin.php"><i class="fa-solid fa-cart-shopping hover:text-indigo-600"></i></a>
            <a href="signin.php"><i class="fa-regular fa-user hover:text-indigo-600"></i></a>
        </div>
    </div>
</nav>
...
<section class="bg-white py-12 border-b border-gray-100">
    <div class="container mx-auto px-6 text-center">
        <h1 class="text-3xl font-bold mb-6">Find your next favorite.</h1>
        <div class="max-w-2xl mx-auto flex shadow-sm rounded-xl overflow-hidden border border-gray-200">
            <input type="text" id="searchInput" placeholder="Search by name, tags, or description..." class="w-full px-5 py-3 outline-none">
            <button onclick="searchProducts()" class="bg-black text-white px-8 py-3 font-semibold hover:bg-gray-800 transition">Search</button>
        </div>
    </div>
</section>
...
<main class="container mx-auto px-6 py-10">
    ...
    <section class="mb-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-white p-4 product-card border border-gray-100">
...
<script>
    ...
    async function searchProducts() {
        ...
        // In a real app, you'd fetch from a PHP API file. 
        // For this demo, we use a fetch to the same page with a flag.
            ...
            products.forEach(p => {
                ...
                <div class="bg-white p-4 product-card border border-gray-100 shadow-sm">
                    ...
                    <div class="flex justify-between items-center mt-4">
                        ...
                        <button onclick='showDetails(${JSON_encode(p)})' class="bg-black text-white px-4 py-2 rounded-lg text-xs">View</button>
                    </div>
                </div>`;
            });
        }
